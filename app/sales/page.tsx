                ...
                <SheetContent side="left" className="w-80">
                  <SheetHeader>
                    <div className="flex items-center gap-3 pb-6">
                      ...
                      <div>
                        <SheetTitle className="text-xl">Welcome back!</SheetTitle>
                      </div>
                    </div>
                  </SheetHeader>
                  <nav className="flex flex-col gap-2">
                    <Link href="/">
                      <Button variant="ghost" className="w-full justify-start gap-3 h-14" size="lg">
                    ...
                    <Button variant="ghost" className="w-full justify-start gap-3 h-14 bg-accent" size="lg">
                  ...
                  <div className="absolute bottom-4 left-4 right-4 space-y-2">
                    ...
                    <p className="text-center text-xs text-muted-foreground pt-4">ShopFlow v1.0.0</p>
                  </div>
                </SheetContent>
              </Sheet>

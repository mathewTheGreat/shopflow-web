        ...
        <div className="flex flex-col items-center space-y-6">
            ...
            <div className="w-full space-y-4">
                ...
                <Link href="/onboarding" className="w-full">
                    <Button className="w-full h-12 text-base bg-blue-600 hover:bg-blue-700 text-white mt-2">Continue &rarr;</Button>
                </Link>
            </div>
            ...
            <div className="relative w-full">
                ...
                <div className="relative flex justify-center text-xs uppercase">
                    <span className="bg-background px-2 text-muted-foreground">Already have an account? <Link href="/login" className="text-blue-500 hover:text-blue-600 font-medium normal-case text-sm">Sign in</Link></span>
                </div>
            </div>

    ...
    <body>
      <div class="variance-report">
        ...
        <div class="report-meta">
          ...
          <div><strong>Shift Status:</strong> <span class="${(() => { const cs = (varianceData as any).shiftClosingStatus; const rr = (varianceData as any).shiftRejectionReason; if (cs === 'APPROVED') return 'badge-approved'; if (cs === 'PENDING_APPROVAL') return 'badge-pending-approval'; if (rr) return 'badge-rejected'; return 'badge-open'; })()}">${(() => { const cs = (varianceData as any).shiftClosingStatus; const rr = (varianceData as any).shiftRejectionReason; if (cs === 'APPROVED') return 'Approved'; if (cs === 'PENDING_APPROVAL') return 'Pending Approval'; if (rr) return 'Rejected'; return 'Open'; })()}</span></div>
        </div>

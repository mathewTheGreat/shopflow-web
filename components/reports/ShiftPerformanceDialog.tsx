    ...
    <body>
      <div class="shift-report">
        ...
        <div class="report-meta">
          ...
          <div><strong>Shift Status:</strong> <span class="${(report as any).closing_status === 'APPROVED' ? 'badge-approved' : (report as any).closing_status === 'PENDING_APPROVAL' ? 'badge-pending-approval' : (report as any).rejection_reasons ? 'badge-rejected' : 'badge-open'}">${(report as any).closing_status === 'APPROVED' ? 'Approved' : (report as any).closing_status === 'PENDING_APPROVAL' ? 'Pending Approval' : (report as any).rejection_reasons ? 'Amendment Requested' : 'Open'}</span></div>
        </div>
